...
import com.base.util.ObjectToJson;
import com.base.util.StringUtil;
import com.base.util.log.ServiceDaoLog;
 ...
 *
 * @Description: Token操作类(生成及解析)
 * 
 * @Company:
 * @Author: ZCX  
 * @CreateDate: 2018年2月9日 上午11:34:32
 * @UpdateDate: 2018年2月9日 上午11:34:32
 * @Version: V1.0
 */
public class JWTTokenOper {
	...
	public static String getSecret(String key) {
		...
		if (StringUtil.isNullOrSpace(SECRET)) {
			SECRET = "XX#$%()(#*!()!KL<><PW" + StringUtil.getUUid();
		}
		
		key = StringUtil.isNullOrSpace(key) ? "" : key;
		//System.out.println(key + SECRET);
		logger.info(ServiceDaoLog.serviceDaoLog("secretKey : " + key + SECRET, "创建 secretKey!! "));
		return key + SECRET;
	}
	 ...
	 * @Throws:
	 *
	 * @CreateDate: 2018年2月26日 下午3:12:31
	 * @ChangeDate: 2018年2月26日 下午3:12:31
	 * @Author: ZCX
	 */
	public static String createJWT(String type, TokenInfo payloadTokenInfo) {
		
		//Token 类型
		type = StringUtil.isNullOrSpace(type) ? "JWT" : type;
	 ...
	 * @Throws:
	 *
	 * @CreateDate: 2018年2月26日 下午3:19:21
	 * @ChangeDate: 2018年2月26日 下午3:19:21
	 * @Author: ZCX
	 */
	 ...
	 * @Throws:
	 *
	 * @CreateDate: 2018年2月26日 下午3:22:05
	 * @ChangeDate: 2018年2月26日 下午3:22:05
	 * @Author: ZCX
	 */
	 ...
	 * @Throws:
	 *
	 * @CreateDate: 2018年2月26日 下午4:02:13
	 * @ChangeDate: 2018年2月26日 下午4:02:13
	 * @Author: ZCX
	 */
	public static boolean parseJwt(String jwt) {
		...
		//	System.out.println(Base64Codec.BASE64URL.decodeToString(payload));
			...
			logger.info("Token.Head : " + Base64Codec.BASE64URL.decodeToString(head));
			logger.info("Token.Payload : " + Base64Codec.BASE64URL.decodeToString(payload));
